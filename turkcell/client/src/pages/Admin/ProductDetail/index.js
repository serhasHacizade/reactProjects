...
const ProductDetail = () => {
    ...
    const handleSubmit = async (values, bag) => {
        ...
        try {
            ...
            message.success({content:"The product succesfully updated", key:"product_update", duration:2});
        } catch (error) {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <FormControl mt="4">
                                            ...
                                            <Input name="title" onChange={handleChange}
                                                onBlur={handleBlur} value={values.title} disabled={isSubmitting}
                                        ...
                                        <FormControl mt="4">
                                            ...
                                            <Textarea name="description" onChange={handleChange}
                                                onBlur={handleBlur} value={values.description} disabled={isSubmitting}
                                        ...
                                        <FormControl mt="4">
                                            ...
                                            <Input name="price" onChange={handleChange}
                                                onBlur={handleBlur} value={values.price} disabled={isSubmitting}
                                                ...
                                                <div>
                                                    {
                                                        values.photos && values.photos.map((photo, index) => (
                                                            <div key={index}>
                                                                <Input name={`photos${index}`} value={photo} disabled={isSubmitting}
                                                                    onChange={handleChange} width="5xl" />
                                                                <Button ml="3" type="button" colorScheme="red"
